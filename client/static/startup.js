...
const icon = document.getElementById('theme-toggler-icon');
...
// 		'beforeend',
// 		'<link id="smui-light" rel="stylesheet" href="/smui.css">\n<link id="smui-dark" rel="stylesheet" href="/smui-dark.css" media="screen" />'
// 	);
// } else {
// 	document.head.insertAdjacentHTML(
// 		'beforeend',
